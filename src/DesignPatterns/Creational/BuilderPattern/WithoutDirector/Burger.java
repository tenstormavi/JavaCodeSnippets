...
/**
 * Most Common Way to implement builder pattern is to have Builder class as inner class because : -
 ...
 * 3. Now since constructor is private we will need inner class to access that. - Which will have same inputs
 * what we have in class. But without getters.
 */
