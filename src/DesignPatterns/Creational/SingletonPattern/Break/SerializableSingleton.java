...
public class SerializableSingleton implements Serializable {
     ...
     */
    private static SerializableSingleton connectionObj;
    ...
    public static SerializableSingleton getInstance() {
        ...
        if (connectionObj == null) {
            ...
            synchronized (SerializableSingleton.class) {
                ...
                if (connectionObj == null) {
                    connectionObj = new SerializableSingleton();
                }
            }
        }
    ...
    /**
     * This is the key method which is responsible during deserialization process. We are overriding it.
     * When this method will get invoked, the JVM will simply return the already created object.
     */
